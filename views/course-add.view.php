    ...
    <form method="POST" class="add course form-container">
        <div class="add course form-wrapper">
            ...
            <div class="add-course-inputs">
                ...
                <input type="text" id="course-name" name="course-name" placeholder="Enter course name" value="<?= cleanStr($_POST['course-name'] ?? "") ?>">

                <label for="description">Description:</label>
                <textarea name="description" id="description"><?= cleanStr($_POST['description'] ?? "") ?></textarea>
            </div>
            ...
            <div class="back-add course-button-wrapper">
                ...
                <div id="add-course button-container">
                    <button type="submit" id="add-course-button">Add Course</button>
                </div>
            </div>
